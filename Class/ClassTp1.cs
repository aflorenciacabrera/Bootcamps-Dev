    ...
    internal class ClassTp1
    {
        ...
        */
        ...
        /* 
            ...
            *************************************************************************
        */
        public void Ejercicio2() //Dado un valor, devolver un mensaje que diga “El valor es mayor que 100 sólo cuando se cumpla dicha condición.
        { 
        ...
        /* 
            ...
            *************************************************************************
        */
        public void Ejercicio3() //Dado un valor, devolver un mensaje que diga “El valor es mayor que 100 sólo cuando se cumpla dicha condición.
        {
        ...
        */
        public void Ejercicio14()
        {
            ...
            int random2 = rand2.Next(0, 100);
            Console.WriteLine("numero random para salir: " + random2);
            ...
            do
            {
                ...
                if (isConvert4)
                {
                    texto = (numero7 > random2) ? "es menor" : "es mayor";
                    texto = (numero7 == random2) ? "el correcto!!!! ADIVINASTE!!!" : texto;
                    Console.WriteLine("El número oculto es {0}", texto);
                }
                else
                    Console.WriteLine("INGRESASTE CUALQUIER COSA");
            } while ((random2 != numero7));
            Console.WriteLine("************************************************************************* ");
        }
